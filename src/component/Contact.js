...
function Contact({ contactAnchor }) {
  return (
    <div>
      <div id="contact" className="section-wrapper" ref={contactAnchor}>
        <div className="section-title title-bottomLine">CONTACT</div>
        <div className="form-wrapper">
          <form
            id="fs-frm"
            name="complaint-form"
            acceptCharset="utf-8"
            action="https://formspree.io/f/xjvzpnak"
            method="post"
          >
          ...
          <div className="contact-info">
            ...
            <h3>0912-144-381</h3>
            <p>
              <a href="g01965250@gmail.com">g01965250@gmail.com</a>
            </p>
          </div>
        </div>
      </div>
